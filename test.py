import pixie
from main import Card, SimpleCard, ComplexCard, TextField, Image
...
test_cc = ComplexCard('test/complex.png')
header = TextField('Heading', '/home/bean/.local/share/fonts/GROBOLD.ttf', 100, margin_y=10, h_align=pixie.CENTER_ALIGN, font_color=(0.2, 1, 0.2, 1))
subtitle = TextField('Subtitle', dejavusans_path, 70, h_align=pixie.CENTER_ALIGN)
divider = Image('/home/bean/Nextcloud/beanstem/short-squiggle.png', margin_y=100, scale=0.75,)
body = TextField('Body text, this is a lot of text that will take up space and hopefully wrap around just so I can make extra sure that it does wrap', dejavusans_path, 50, h_align=pixie.RIGHT_ALIGN)
